...
DEFINE_HOOK(74036E, FooClass_GetCursorOverObject, 5)
{
...
DEFINE_HOOK(66D55E, Buf_General, 6)
{
	...
	DWORD Sum = Rules->get_SecretInfantry()->get_Count()
		+ Rules->get_SecretUnits()->get_Count()
		+ Rules->get_SecretBuildings()->get_Count();
